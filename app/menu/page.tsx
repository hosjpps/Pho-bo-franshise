...
const menuCategories = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Нэм", price: "550₽", description: "Обжаренные блинчики с овощами. На выбор: курица (3 шт, 150/30 г) / морепродукты со свининой (4 шт, 180/30 г)", weight: "", image: "/Нэм.jpg" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Вода Черноголовка", price: "", description: "С газом / без газа", weight: "500 мл", image: "/Черноголовка вода без газа 0,5 ПЭТ.jpg" },
      ...
      { name: "Лимонады Черноголовка", price: "", description: "Тархун, Дюшес, Мандарин, Дикий апельсин, Кола, Кола Zero, Кола лайм-мята", weight: "500 мл", image: "/Черноголовка Кола Классик (ПЭТ, 0.5).jpg" },
      { name: "Чай Черноголовка", price: "", description: "Лимон-лайм, Лайм-мята", weight: "500 мл", image: "/Черноголовка Зеленый чай Лайм мята (ПЭТ, 0.5).jpg" },
      { name: "Лимонады Черноголовка 0.33", price: "", description: "Дикий апельсин, Бодрый цитрус, Лайм-мята", weight: "330 мл", image: "/Черноголовка Mixes Лимон Лайм (ЖБ 0,33).jpg" },
      { name: "Вьетнамский лимонад", price: "от 210₽", description: "Личи, Кокос, Гуава, Манго, Маракуйя. 1 шт — 210₽, 3 шт — 590₽, 6 шт — 1090₽", weight: "330 мл", image: "/Вьетнамский лимонад.jpg" },
    ],
  },
  {
    name: "Вьетнамские напитки",
    items: [
      { name: "Жасминовый чай", price: "", description: "Вьетнамский чай с жасмином и лимоном", weight: "400 мл", image: "/жасмин.jpg" },
      { name: "Кофе по-вьетнамски со льдом", price: "290₽", description: "Традиционный вьетнамский кофе со сгущённым молоком и льдом", weight: "300 мл", image: "/кофе.jpg" },
      { name: "Сок Апельсин-Маракуйя", price: "390₽", description: "Свежий сок из апельсина и маракуйи", weight: "400 мл", image: "/Сок Апельсин-Маракуйя.jpg" },
      { name: "Чай персик-апельсин-лемонграсс", price: "390₽", description: "Фруктовый чай с персиком, апельсином и лемонграссом", weight: "400 мл", image: "/чай персик апельсин лемонграсс.jpg" },
      { name: "Напиток из вьетнамского кабачка", price: "", description: "Освежающий вьетнамский напиток из кабачка с лаймом", weight: "400 мл", image: "/Напиток из вьетнамского кабачка.jpg" },
      { name: "Чай с тропическими фруктами", price: "390₽", description: "Чай с манго, папайей и тропическими фруктами", weight: "400 мл", image: "/Чай с тропическими фруктами.jpg" },
    ],
  },
  {
    name: "Фреши",
