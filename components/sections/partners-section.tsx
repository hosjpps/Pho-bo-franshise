...
const partners: {
...
}[] = [
  {
    ...
    period: "руб/мес",
    payback: "6 мес",
    comment: "Открыл точку в торговом центре — поток гостей с первого дня. Команда PhoBo помогла с выбором локации, обучением персонала и запуском. Выручка в день открытия составила 320 000 руб., стабильный рост каждый месяц.",
    hasVideo: false,
  },
  {
    name: "Евгений",
