      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="sm:hidden text-center mb-8">
          ...
          <div className="grid grid-cols-3 gap-4 text-center mb-6 pt-4 border-t border-white/10">
            <div>
              <h4 className="font-semibold text-xs text-white/60 uppercase tracking-wider mb-2">Компания</h4>
            ...
            <div>
              <h4 className="font-semibold text-xs text-white/60 uppercase tracking-wider mb-2">Франшиза</h4>
              <ul className="space-y-1.5">
            ...
            <div>
              <h4 className="font-semibold text-xs text-white/60 uppercase tracking-wider mb-2">Документы</h4>
              <ul className="space-y-1.5">
